...
if __name__ == "__main__":
    ...
    s_station_list = r'.\Inputs\upper_stanislaus_data_stations.csv'
    ...
    # save to csvs
    df_gauge_data_original.to_csv('./Intermediate/upper_stanislaus_gauge_data_original.csv')
    df_gauge_data_monthly_taf.to_csv('./Intermediate/upper_stanislaus_gauge_data_monthly_taf.csv')

    # combine the new data with the previous data
    df_full_data = read_previous_data(s_previous_data, df_gauge_data_monthly_taf)
    # save to a csv
    df_full_data.to_csv('./Intermediate/upper_stanislaus_full_gauge_data.csv')
